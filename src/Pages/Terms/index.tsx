...
const Terms: React.FC = () => (
    <Container>
        ...
        <PrivacyContainer>
            ...
            <p>
                Ao acessar ao site{' '}
                <a href="https://douglasndm.dev">douglasndm</a>, concorda em
            ...
            <p>
                ...
                materiais (informações ou software) no site douglasndm , apenas
            ...
            <ol>
                ...
                <li>
                    ...
                    software contido no site douglasndm;
                </li>
                <li>
            ...
            <p>
                ...
                alguma dessas restrições e poderá ser rescindida por douglasndm
            ...
            <ol>
                <li>
                    Os materiais no site da douglasndm são fornecidos &apos;como
                    estão&apos;. douglasndm não oferece garantias, expressas ou
                ...
                <li>
                    Além disso, o douglasndm não garante ou faz qualquer
            ...
            <h2>4. Limitações</h2>
            <p>
                Em nenhum caso o douglasndm ou seus fornecedores serão
                ...
                materiais em douglasndm, mesmo que douglasndm ou um
                representante autorizado da douglasndm tenha sido notificado
            ...
            <p>
                Os materiais exibidos no site da douglasndm podem incluir erros
                técnicos, tipográficos ou fotográficos. douglasndm não garante
                que qualquer material em seu site seja preciso, completo ou
                atual. douglasndm pode fazer alterações nos materiais contidos
                em seu site a qualquer momento, sem aviso prévio. No entanto,
                douglasndm não se compromete a atualizar os materiais.
            </p>
            <h2>6. Links</h2>
            <p>
                O douglasndm não analisou todos os sites vinculados ao seu site
                e não é responsável pelo conteúdo de nenhum site vinculado. A
                inclusão de qualquer link não implica endosso por douglasndm do
                site. O uso de qualquer site vinculado é por conta e risco do
                usuário.
            </p>
            <h3>Modificações</h3>
            <p>
                O douglasndm pode revisar estes termos de serviço do site a
            ...
            <p>
                ...
                com as leis do douglasndm e você se submete irrevogavelmente à
